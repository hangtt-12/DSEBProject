...
class Compute_and_display:
    def __init__(self, file_name1="data.json"):
        self.current_streak = self.countt_streak(file_name1)
        self.achievements = [
    ...
    def countt_streak(self, file_name1):
    ...
    def do_you_know(self, file_name2):
...
class MyApp(MDApp):
    def build(self):
        ...
        row_1 = MDBoxLayout(orientation='vertical', size_hint_y=0.5, spacing = 10)
        ...
        topic , solution = inf.do_you_know("facts.json")
